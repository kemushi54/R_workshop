...
<p>Excel、Power BI 也都是很好的工具，但我覺得在時間許可的情況下，可以給自己一些機會去接觸不同的工具，讓你在處理事情時有不同的選項。在今天的課程結束後，如果覺得拖拉點選式還是比較適合自己，可以回去投入 excel 的懷抱沒關係，真的。工具就是要拿來減輕你的負擔，如果使用工具反而讓你覺得事倍功半，那就失去了使用工具的意義了</p>
</div>